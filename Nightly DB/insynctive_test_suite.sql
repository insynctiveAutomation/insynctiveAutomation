...
CREATE TABLE `test_suite` (
  ...
  `dependsTestSuite_test_suite_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`test_suite_id`),
  KEY `FK7B68C90B1B5A7588` (`dependsTestSuite_test_suite_id`),
  CONSTRAINT `FK7B68C90B1B5A7588` FOREIGN KEY (`dependsTestSuite_test_suite_id`) REFERENCES `test_suite` (`test_suite_id`)
...
INSERT INTO `test_suite` VALUES (4,'Loading Test',NULL),(5,'Loading Test',NULL),(6,'Loading Test',NULL),(7,'Person File',NULL),(8,'Person File',NULL),(9,'Person File',NULL);
